...
""")
    grprprtby.add_argument('--report-by-subdirs', dest='bysubdirs',  action='store_true',
                       help="""report by subdirectories of this parent directory

""")
    parser.add_argument('--nthreads=', dest='ncores', default=40, metavar='number-of-cores or processes',
                      help="""Number of cores / threads to run

...
#. run :doc:`gcache </gcache>` (with appropriate options)
...
The :doc:`gcache </gcache>` spawns GUFI query to **squall1** and stores 
the output into <gufi_tmp> tree. The :doc:`grprt </grprt>` reads the
raw report generated by :doc:`gcache </gcache>` and generates more useful
